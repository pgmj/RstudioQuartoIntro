...
```{r}
write.csv(df.long,"dataLong.csv")
```
...
::: {.callout-note}
This section will mostly be skimmed and the various plots and solutions are included for you to use as a reference if/when you would like to implement something similar in your future analyses.
:::
...
Plot/table of age+gender for df2's spss file. Start with:
```
