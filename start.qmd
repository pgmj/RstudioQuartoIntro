...
- decimal is always *`.`*! Commas are used to separate things.
...
A dataframe is a collection of rows/participants (vectors) and columns/variables (also vectors).
