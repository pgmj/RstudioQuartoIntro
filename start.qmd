...
Below we define preferred functions that are frequently used. We can still use specific functions by using their package prefix, for instance `dplyr::recode()`.
```{r}
### 
select <- dplyr::select
count <- dplyr::count
